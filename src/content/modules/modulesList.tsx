      ...
      let modules = [
        {
            ...
            square: false,
            svg: 
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-12 -12 48 48" fill="currentColor" class="size-6 text-white">
        ...
        },
        {
            ...
            square: false,
            svg: 
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-12 -12 48 48" fill="currentColor" class="size-6">
        ...
        
        {
            ...
            desc: "Un module permettant de suivre et d'analyser les données de l'application, telles que le nombre de visites, le comportement des utilisateurs, les taux de conversion, les performances des pages, etc. Intégration avec des outils comme Google Analytics, Mixpanel, etc.",
            bg: true,
            square: false,
            svg: 
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-12 -12 48 48" fill="currentColor" class="size-6 text-rose-400">
    ...
    return (
        <div class="max-w-[85rem] mx-auto">
            <div class="px-4 lg:px-0 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {modules.map(module => (
                    <ModuleCard title={module.title} desc={module.desc} bg={module.bg} svg={module.svg} color={module.color} square={module.square} />
                ))}
            </div>
        </div>
    )
